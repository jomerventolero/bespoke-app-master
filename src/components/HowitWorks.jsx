...
const HowitWorks = () => {
  return (
    <div id="howitworks">
        <motion.div className="relative flex flex-col justify center px-10"
            ...
            <div className="absolute top-[18%] left-1/4 transform -translate-x-1/4  text-brandBlack text-2xl p-5 font-poppins ">
