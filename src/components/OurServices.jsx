    ...
    <section id="ourservices">
        <div>
            ...
            <div className="flex justify-center pb-8">
                <h1 className={`text-brandBlue ${styles.textResH2} 
                font-poppins font-semibold pl-4 py-4`}>BPO services commonly used by</h1>
                <h1 className={`text-brandBlack ${styles.textResH2} 
            ...
            <div className="flex flex-row">
                ...
                <div className="flex flex-col pl-[15%]">
                    ...
                    <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Data Entry</h1>
                    ...
                    <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Invoice Processing</h1>
                    ...
                    <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Freight Bill Processing</h1>
            ...
            <div className="px-[15%]">
                ...
                <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Accounting</h1>
                <p className={`text-justify ${styles.textResP} pb-6 leading-relaxed`}>Like any other industry, accurate accounting is crucial. Part of how & why freight forwarding companies use Bepoke's services is the financial calculating that can be time consuming and tedious. Bespoke takes care of your accounting functions so that you do not have to waste any time that could be more valuable used in other areas.</p>
                <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Document Indexing</h1>
                ...
                <h1 className={`${styles.textResH2} text-brandBlue font-semibold pb-6`}>Data Management</h1>
                <p className={`text-justify ${styles.textResP} pb-6 leading-relaxed`}>In addition to data entry, Bepoke can also manage your company’s data. One of the main aspects of how & why freight forwarding companies use BPO services is to effectively carry out data-related services. Data management involves executing all necessary data-related processes.</p>
