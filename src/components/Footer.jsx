...
const Footer = () =>  {
    ...
    return(
        <div className={`p-1 w-full flex flex-row gap-[1%] pt-8 justify-around`}>
            ...
            <div className="xs:px-0 sm:px-0 md:px-0 px-4">
                <h2 className={`text-brandBlue font-poppins font-bold`}>
                    CONTACT US
                </h2>
                <p className={`font-semibold`}>
                    info@mybespokestaff.com
                </p>
                <h2 className={`text-brandBlue font-bold  pt-8`}>
                    COMPANY ADDRESS
                </h2>
            ...
            <div className={`  xs:px-2 px-4`}>
                <h2 className={`text-brandBlue font-poppins font-bold mb-2`}>
                    QUICK LINKS
                </h2>
            ...
            <div className={`  px-8 xs:block hidden`}>
                <h2 className={`text-brandBlue font-poppins font-bold`}>
                    SITE TOOLS
                </h2>
                <ul>
