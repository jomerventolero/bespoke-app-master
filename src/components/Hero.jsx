  ...
  <section id="home" className={`md:flex-row flex-col w-full`}>
      <div className="w-full h-full overflow-hidden bg-gradient-to-t from-indigo-300 via-brandBlue to-blue-300 text-white font-bold pl-5">
        <div className={`flex flex-row justify-between items-center`}>
          <div className='pl-12'>
            <h1 className={`sm:flex hidden flex-1 font-poppins font-semibold ${styles.textResH1} pb-6 text-white ss:leading-[100px] leading-[75px]`}>
      ...
      <div className='pr-[50px] pl-[50px] sm:flex hidden'>
